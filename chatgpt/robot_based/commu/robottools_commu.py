...
class RobotTools(object):
    ...
    def make_beat_motion(self, duration_seconds:float, speed=1.0):
        DEFAULT_ARM_SERVO_MAP = dict(R_SHOU_R=0, R_SHOU_P=-60, L_SHOU_R=0, L_SHOU_P=60)
        BEAT_ARM_SERVO_MAP_LIST = (
            dict(R_SHOU_R=29, R_SHOU_P=-23, L_SHOU_R=-21, L_SHOU_P=-13),
            dict(R_SHOU_R=12, R_SHOU_P=4,   L_SHOU_R=-10, L_SHOU_P=0),
            dict(R_SHOU_R=15, R_SHOU_P=-4,  L_SHOU_R=-6,  L_SHOU_P=10),
            dict(R_SHOU_R=27, R_SHOU_P=0,   L_SHOU_R=-10, L_SHOU_P=26),
            dict(R_SHOU_R=19, R_SHOU_P=-12, L_SHOU_R=-26, L_SHOU_P=-14),
            dict(R_SHOU_R=15, R_SHOU_P=10,  L_SHOU_R=-11, L_SHOU_P=-9)
        )
        def __choose(prev):
            while True:
